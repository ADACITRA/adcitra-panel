var lan = {
	...
	"config":{
		...
		"config_user_binding":"Binding AdCtira Account",
		"config_user_edit":"Change AdCtira Account",
		"binding":"Bind",
		"token_get":"Obtaining Private key...",
		"user_bt":"AdCtira User Name",
		"pass_bt":"AdCtira Password",
		"binding_un_msg":"Are you sure that unbind AdCtira Account？",
	...
	"site":{
		...
		"ssl_close":"CloseSSL",
		"bt_bind_no":"Does not bind AdCtira account, please create new account,and bind AdCtira account for applying one-click deploy SSL",
		"bt_user":"AdCtira",
		"login":"Login",
		"bt_reg":"Register AdCtira account",
		"bt_ssl_help_1":"AdCtira SSL is (TrustAsia) certification, needs real name identification",
		"bt_ssl_help_2":"If you have AdCtira account, please bind it after login",
		"bt_ssl_help_3":"AdCtira SSL applys from TrustAsia DV SSL CA - G5 original price：1900RMB/year，AdCtira user is free to use！",
		"bt_ssl_help_4":"Automatic issus to user after one year of using AdCtira.",
		"btapply":"Apply",
		...
		"bt_ssl_help_6":"AdCtira SSL certification applying is free version of TrustAsia DV SSL CA - G5 certification，Only support to use into single domain",
		...
		"bt_ssl_help_10":"Paste you KEY and CRT content, and then save it<a href='http://www.adcitra.cn/bbs/thread-704-1-1.html' class='btlink' target='_blank'>[HELP]</a>。",
