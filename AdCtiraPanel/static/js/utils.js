var lan = {
	get: function (_, e) {
		...
		if (!t[_]) return ''
		msg = t[_]
		for (var s = 0; s < e.length; s++) msg = msg.replace('{' + (s + 1) + '}', e[s] + '')
		return msg
	},
	index: {
		memre: '内存释放',
		...
		process_act: '操作',
		kill_msg: '正在结束进程...',
		rep_panel_msg: '修复面板会获取最新的面板代码程序，<br>包括BUG修复，是否继续操作？',
		rep_panel_title: '修复面板',
		rep_panel_the: '正在校验模块...',
		rep_panel_ok: '修复完成，请按 Ctrl+F5 刷新缓存!'
	},
	config: {
		close_panel_msg: '关闭面板会导致您无法访问面板 ,您真的要关闭AdCtira灯塔Linux面板吗？',
		close_panel_title: '关闭面板',
		config_save: '正在保存配置...',
		config_sync: '正在同步时间...',
		config_user_binding: '绑定AdCtira灯塔帐号',
		config_user_edit: '修改绑定AdCtira灯塔账号',
		binding: '绑定',
		token_get: '正在获取密钥...',
		user_bt: 'AdCtira灯塔官网账户',
		pass_bt: 'AdCtira灯塔官网密码',
		binding_un_msg: '您确定要解除绑定AdCtira灯塔帐号码？',
	...
	control: { save_day_err: '保存天数不合法!', close_log: '清空记录', close_log_msg: '您真的清空所有监控记录吗？', disk_read_num: '读取次数', disk_write_num: '写入次数', disk_read_bytes: '读取字节数', disk_write_bytes: '写入字节数' },
	crontab: {
	...
	database: {
		...
		input_ps1: '仅支持sql、zip、sql.gz、(tar.gz|gz|tgz)',
		...
		input_up_type: '请上传sql、zip、sql.gz、(tar.gz|gz|tgz)',
	...
	site: {
		...
		ssl_crt: '证书(PEM格式)',
		ssl_close: '关闭SSL',
		bt_bind_no: '未绑定AdCtira灯塔账号，请注册绑定，绑定AdCtira灯塔账号(非论坛账号)可实现一键部署SSL',
		bt_user: 'AdCtira灯塔账号',
		login: '登录',
		bt_reg: '注册AdCtira灯塔账号',
		bt_ssl_help_1: 'AdCtira灯塔SSL证书为亚洲诚信证书，需要实名认证才能申请使用',
		bt_ssl_help_2: '已有AdCtira灯塔账号请登录绑定',
		bt_ssl_help_3: 'AdCtira灯塔SSL申请的是TrustAsia DV SSL CA - G5 原价：1900元/1年，AdCtira灯塔用户免费！',
		bt_ssl_help_4: '一年满期后免费颁发',
		btapply: '申请',
		endtime: '到期时间',
		status: '状态',
		bt_ssl_help_5: '申请之前，请确保域名已解析，如未解析会导致审核失败',
		bt_ssl_help_6: 'AdCtira灯塔SSL申请的是免费版TrustAsia DV SSL CA - G5证书，仅支持单个域名申请',
		bt_ssl_help_7: '有效期1年，不支持续签，到期后需要重新申请',
		bt_ssl_help_8: "Let's Encrypt免费证书，有效期3个月，支持多域名默认会自动续签",
		bt_ssl_help_9: '若您的站点使用了CDN或301重定向会导致续签失败',
		bt_ssl_help_10: "粘贴您的*.key以及*.pem内容，然后保存即可<a href='http://www.adcitra.cn/bbs/thread-704-1-1.html' class='btlink' target='_blank'>[帮助]</a>",
		phone_input: '请输入手机号码',
	...
	soft_info_detail: {
		datid: '数据库OID（Object Identifier）',
		datname: '数据库名称',
		numbackends: '已连接到此数据库的后端数量',
		xact_commit: '数据库提交的事务数量',
		xact_rollback: '数据库回滚的事务数量',
		blks_read: '数据库从磁盘读取的块数',
		blks_hit: '数据库从共享缓存中读取的块数',
		tup_inserted: '数据库检索的行数',
		tup_fetched: '数据库检索的行数含“WHERE”限制',
		deadlocks: '数据库由于死锁而导致的回滚数',
		stats_reset: '最后一次重置统计信息的时间',
		active_connections: '当前活跃连接数',
		accepts: '接收的TCP连接数',
		handled: '成功处理的TCP连接数',
		requests: '处理的HTTP请求总数',
		Reading: '正在读取数据的TCP连接数',
		Writing: '正在写入数据的TCP连接数',
		Waiting: '可用连接的空闲TCP连接数',
		bind: '绑定的IP地址',
		port: '运行的端口号',
		maxconn: '可同时处理的最大连接数',
		cachesize: '使用的内存大小',
		...
		cmd_get: '执行get命令的次数',
		get_hits: 'get命中缓存的次数',
		get_misses: 'get没有命中缓存的次数',
		bytes_read: '读取字节数',
		bytes_written: '写入字节数',
		limit_maxbytes: '服务器可使用的最大内存大小',
		bytes: '当前存储数据所占用的字节数',
		curr_items: '当前缓存条目数量',
		evictions: '缓存淘汰的条目数量',
		hit: '命中率，即get命中率',
		Aborted_clients: '服务器主动中断的数量',
		Aborted_connects: '连接失败的数量',
		Bytes_received: '接收到的字节数',
		Bytes_sent: '发送的字节数',
		Com_commit: '提交的事务数量',
		Com_rollback: '回滚的事务数量',
		Connections: '已经建立的连接数量',
		Created_tmp_disk_tables: '创建的临时磁盘表数量',
		Created_tmp_tables: '创建的临时表数量',
		Innodb_buffer_pool_pages_dirty: '当前脏页数量',
		Innodb_buffer_pool_read_requests: ' 从缓冲池中读取的请求数量',
		Innodb_buffer_pool_reads: '从磁盘中读取的数量',
		Key_read_requests: '从缓存中读取索引的请求数量',
		Key_reads: '从磁盘中读取索引的数量',
		Key_write_requests: '向缓存中写入索引的请求数量',
		Key_writes: '向磁盘中写入索引的数量',
		Max_used_connections: '最大同时连接数量',
		Open_tables: '当前打开的表数量',
		Opened_files: '打开的文件数量',
		Opened_tables: '打开的表数量',
		Qcache_hits: '查询缓存命中数量',
		Qcache_inserts: '查询缓存插入数量',
		Questions: '执行的查询数量',
		Select_full_join: '全表关联查询数量',
		Select_range_check: '范围检查查询数量',
		Sort_merge_passes: '排序合并操作的次数',
		Table_locks_waited: '等待表锁的次数',
		Threads_cached: '缓存的线程数量',
		Threads_connected: '当前连接的线程数量',
		Threads_created: ' 创建的线程数量',
		Threads_running: '正在运行的线程数量',
		Uptime: '服务运行时间',
		Thread_cache_hit_ratio: '线程缓存命中率',
		Index_hit_ratio: '索引命中率',
		Innodb_index_hit_ratio: 'Innodb索引命中率',
		Query_cache_hit_ratio: '查询缓存命中率',
		tcp_port: '服务器监听的TCP端口号',
		uptime_in_days: '服务器运行的天数',
		connected_clients: '当前连接到Redis服务器的客户端数量',
		used_memory: '服务器当前占用的内存大小',
		used_memory_rss: '服务器使用的常驻内存大小',
		used_memory_peak: '服务器最高峰时使用的内存大小',
		mem_fragmentation_ratio: '内存碎片率',
		total_connections_received: '服务器总共接受过的连接数',
		total_commands_processed: '服务器总共执行过的命令数',
		instantaneous_ops_per_sec: '服务器瞬时执行命令速率',
		keyspace_hits: '命中缓存的键值对数量',
		keyspace_misses: '未命中缓存的键值对数量',
		latest_fork_usec: '最近一次fork操作消耗的时间',
		version: '版本号',
		now_connection: '最大并发数',
		maximum_connection: '可以建立的最大连接数',
		query_num: '查询操作的数量',
		insert_num: '插入操作的数量',
		update_num: '更新操作的数量',
		delete_num: '删除操作的数量',
		hit_times: '操作的执行时间',
		misses_hit: '操作执行的失败次数',
		dataSize: '数据量',
		storageSize: '存储空间',
		resident: '当前驻留的内存大小',
		ChrootEveryone: '是否需要chroot才能登录FTP服务器',
		BrokenClientsCompatibility: '是否支持FTP服务器的broken client兼容性',
		MaxClientsNumber: '最大允许的FTP客户端数量',
		Daemonize: '是否启用daemon模式',
		MaxClientsPerIP: '每个IP地址最大允许的FTP客户端数量',
		VerboseLog: '是否输出详细的FTP日志信息',
		DisplayDotFiles: '是否显示FTP文件的DOT符号',
		AnonymousOnly: '是否只允许匿名用户登录FTP服务器',
		NoAnonymous: '是否允许匿名用户登录FTP服务器',
		SyslogFacility: '使用FTP的系统日志记录方式',
		DontResolve: '是否禁用 DNS 解析',
		MaxIdleTime: '设置 FTP 服务器的最大空闲时间',
		PureDB: '纯 FTP 服务器的 PDB 文件路径',
		UnixAuthentication: '是否使用 Unix 认证方式',
		LimitRecursion: '设置 FTP 服务器的最大重试次数',
		AnonymousCanCreateDirs: '是否禁止匿名用户创建目录',
		MaxLoad: '设置FTP服务器的最大负载',
		PassivePortRange: 'FTP服务器的passive端口范围',
		AntiWarez: '启用Anti-WebDAV功能',
		Umask: '设置文件的权限模式',
		MinUID: '最小用户ID',
		AllowUserFXP: '是否允许使用FTPFX协议',
		AllowAnonymousFXP: '是否允许匿名登FTPFX协议',
		ProhibitDotFilesWrite: '是否禁止写入dot文件',
		ProhibitDotFilesRead: '是否禁止读取.dot文件',
		AutoRename: '用于自动重命名文件',
		AnonymousCantUpload: '是否禁止匿名用户上传文件',
		CreateHomeDir: '是否创建FTP服务器的主目录',
		PIDFile: '服务器的进程ID文件的路径',
		MaxDiskUsage: '服务器的最大磁盘使用量',
		CustomerProof: '服务器的客户端证书',
		TLS: '服务器的TLS协议',
		AllowOverwrite: '是否允许用户覆盖文件',
		AllowStoreRestart: '是否允许在服务器重启时自动重新加载FTP服务器',
		free_memory: '当前Java应用程序可用的内存大小',
		total_memory: '服务器的总内存大小',
		max_memory: '可以使用的最大内存大小',
		maxThreads: '运行的最大线程数',
		currentThreadCount: '运行的线程数',
		currentThreadsBusy: '繁忙的线程数',
		maxTime: '服务器可以运行的最大时间',
		processingTime: '服务器处理请求所需的时间',
		requestCount: '当前正在处理的请求数',
		errorCount: '当前错误的请求数',
		bytesReceived: '当前已经接收到的字节数',
		bytesSent: '当前已经发送的字节数',
		RestartTime: '重启时间',
		UpTime: '的运行时间',
		TotalAccesses: '已经处理的请求数',
		TotalKBytes: '已经处理的字节数',
		ReqPerSec: '每秒处理的请求数',
		BusyWorkers: '线程数',
		IdleWorkers: '空闲的线程数',
		workercpu: '线程的CPU使用率',
		workermem: '线程的内存使用率',
		apache_RestartTime: '服务器的重启时间',
		apache_UpTime: '服务器的运行时间',
		apache_TotalAccesses: '服务器处理的总请求数',
		apache_TotalKBytes: '服务器处理的总字节数',
		apache_ReqPerSec: '平均每秒的请求数',
		apache_BusyWorkers: '正在处理请求的工作进程数',
		apache_IdleWorkers: '空闲工作进程数',
		apache_workercpu: '工作进程的 CPU 占用率',
		apache_workermem: '工作进程的内存占用',
		soft_info: '查询结果'
	}
}
...
var bt = {
	...
	site: {
		...
		fullScreenLog: function (data, row, type, flag) {
			...
			$('.full')
				...
				.click(function () {
					layerTemplate({
						content: flag ? '<div id="editor-content" style="height: 100%;"></div>' : '<pre style="background:black;color:white;height:100%;margin:0">' + data.html() + '</pre>',
						success: function (layers) {
							if (flag) {
								var editor_content = {
									el: 'editor-content',
	...
	soft: {
		...
		set_lib_config: function (name, title, version, endtime) {
			...
			var list = ['adcitrawaf_httpd', 'adcitrawaf', 'total', 'rsync', 'tamper_proof', 'syssafe', 'task_manager', 'security_notice', 'tamper_core', 'bt_security', 'system_scan', 'vuln_push', 'disk_analysis']
		...
		product_pay_view: function (options) {
			window.parent.postMessage('ProductPayView::' + JSON.stringify(options), '*')
		}
	},
	firewall: {
		/**
		...
		bt.send(
			...
			function (rdata) {
				...
				for (var f = 0; f < rdata.DIR.length; f++) {
					...
					d +=
						'<tr><td>' +
						(type === 'all' || type === 'dir' || type === 'multiple' ? '<span style="display: flex;align-items: center;"><input style="margin: 0;" type="checkbox" name="fileCheck" /></span>' : '') +
				...
				if (rdata.FILES !== null && rdata.FILES !== '') {
					for (var f = 0; f < rdata.FILES.length; f++) {
						...
						d +=
							'<tr><td>' +
							(type === 'all' || type === 'file' || type === 'multiple' ? '<span  style="display: flex;align-items: center;"><input style="margin: 0;" type="checkbox" name="fileCheck" /></span>' : '') +
						...
						},
						{
							group: {
								...
								event: function (formData, element, that) {
									...
									bt_tools.send(
										{ url: 'config?action=write_nps_new', data: { questions: JSON.stringify(config), software_name: 1, rate: 0, product_type: param.proType } },
										function (ress) {
											if (ress.status) {
												openFeed.close()
												layer.open({
	...
	render_ps: function (item) {
		...
		html += '<p style="margin-bottom: 19px; margin-top: 11px; color: var(--el-color-text-secondary)"></p>'
		return html
	},
			...
			if (obj.data.length > 0) {
				...
				if ($(obj.table).attr('id') == 'softList') {
					_tab
						...
						.html(
							"<a class=\"btlink\" onclick=\"bt.openFeedback({title:'灯塔面板需求反馈收集',placeholder:'<span>如果您在使用过程中遇到任何问题或功能不完善，请将您的问题或需求详细描述给我们，</span><br>我们将尽力为您解决或完善。',recover:'我们特别重视您的需求反馈，我们会定期每周进行需求评审。希望能更好的帮到您',key:993,proType:16})\">未查询到搜索内容,提交需求反馈</a>"
						)
					$('.soft-search').after(
						'<a class="btlink npsFeedBack ml20" style="line-height: 30px" onclick="bt.openFeedback({title:\'灯塔面板需求反馈收集\',placeholder:\'<span>如果您在使用过程中遇到任何问题或功能不完善，请将您的问题或需求详细描述给我们，</span><br>我们将尽力为您解决或完善。\',recover:\'我们特别重视您的需求反馈，我们会定期每周进行需求评审。希望能更好的帮到您\',key:993,proType:16})">未查询到搜索内容,提交需求反馈</a>'
					)
				}
			}
			$(obj.table)
		...
		layer.open({
			...
			content:
				'<div class="service_consult">\
						<div class="service_consult_title" style="background: rgba(32, 165, 58, 0.1);"><a href="https://www.adcitra.cn/new/wechat_customer" target="_blank" class="btlink" style="display: flex;"><span style="border-bottom: 1px solid;">点击咨询客服</span><div class="svgtofont-arrow" style="width: 15px;height: 18px;margin-top: 1px;margin-left: 5px;vertical-align: middle;"></div></a></div>\
						<div class="contact_consult" style="margin: 10px auto 8px auto;">\
							<div id="contact_consult_qcode">\
								<img style="border: none;width: 140px;display: inline;" src="/static/images/other/customer-qrcode.png" alt="" />\
							</div>\
						</div>\
						<div class="wechat-title">\
						<img class="icon" style="width: 16px;height: 16px;display: inline;" src="data:image/png;base64,">\
		...
		ReaderTable.prototype = {
						...
						for (var j = 0; j < column.length; j++) {
							...
							if (i === 0 && !_that.init) {
								...
								thead +=
									...
									'>' +
									(item.type == 'checkbox' ? '<label><i class="cust—checkbox cursor-pointer ' + checkboxName + '" data-checkbox="all"></i><input type="checkbox" class="cust—checkbox-input"></label>' : '<span>' + item.title + '</span>') +
					...
					if (template) {
						...
						if (tools_group.length) {
							...
							var tools_group_elment =
								'<div class="tootls_group tootls_' + positon[1] + '"><div class="pull-left">' + (positon[0] === 'left' ? template : '') + '</div><div class="pull-right">' + (positon[0] === 'right' ? template : '') + '</div></div>'
							if (positon[1] === 'top') {
			...
			$custom_page: function (total) {
				...
				if (page <= 10) {
					...
					;(0 == tmpPageIndex && (tmpPageIndex = config.page), (tmpPageIndex <= config.page - 5 || tmpPageIndex >= config.page + 5) && (tmpPageIndex = config.page), (html += '<a class="Pnum" href="p=1">1</a>'), (html += '<span>...</span>'))
				...
				return (page > 1 && config.page < page && (html += '<a class="Pstart" href="p=' + (config.page + 1) + '">下一页</a><a class="Pstart" href="p=' + page + '">尾页</a>'), (html += '<span class="Pcount">共' + total + '条</span></div>'))
			},
		...
		ReaderForm.prototype = {
				...
				try {
					...
					return (
						...
						(typeof data.label !== 'undefined'
							? '<span class="tname" ' + (labelWidth ? 'style="width:' + labelWidth + '"' : '') + '>' + (typeof data.must !== 'undefined' && data.must != '' ? '<span class="color-red mr5">' + data.must + '</span>' : '') + data.label + '</span>'
							: '') +
						'<div class="' +
						(data.label ? 'info-r' : '') +
			...
			$reader_select: function (item, style, attribute, index) {
				...
				return (
					...
					(list || '<div style="height:80px;display:inline-flex;align-items:center;justify-content:center;color:#999;width:100%">无数据</div>') +
					'</ul>' +
					'<select' +
					attribute +
					' class="hide" ' +
	...
	tab: function (config) {
		...
		ReaderTab.prototype = {
			...
			$reader_content: function () {
				...
				that.element = $(
					'<div id="tab_' + that.random + '" class="' + _theme['content'] + _that.$verify(that.config['class']) + '"><div class="' + _theme['nav'] + '" >' + _tab + '</div><div class="' + _theme['body'] + '">' + _tab_con + '</div></div>'
				)
	...
	command_line_output: function (config) {
		...
		ReaderCommand.prototype = {
			...
			init: function () {
				...
				this.element_detection = setInterval(
					function () {
      ...
      <div>\
         <div class="nps-star pd20" style="padding-top: 30px">\
            <div>\
              ...
              <div style="font-size: var(--el-font-size-base);text-align: left;color: #000;">您对【' +
			config.name +
			'】功能的满意程度？</div>\
			...
			(config.name === '网站'
				? '<div class="mtb10 c6">如遇BUG问题请联系QQ群：<a class="btlink" title="灯塔面板交流群-2群" href="https://qm.qq.com/cgi-bin/qm/qr?k=pDI9rilMP7Bcf8NcXlk_9ar3_sTLEuaZ&jump_from=webapi&authKey=jLsyfgvmymKrdZrhWRAr3bTn8DkPA/PsqQ+cWw17PvbaKPcy+SteMP8ZmGVZW3yL" target="_blank">435590797</a></div>'
				: '') +
...
var win_mount = {
	...
	showErrorMessage: function (gltxt, find, Buy) {
        ...
        <ul class="help-info-text err_project_ul" style="display:inline-block">\
          ...
          <li style="list-style: none;">修复方案二：如上述尝试未能解除此错误，请截图此窗口到AdCtira灯塔论坛发贴寻求帮助, 论坛地址：<a class="btlink" href="https://www.adcitra.cn/bbs" target="_blank">https://www.adcitra.cn/bbs</a><a href="javascript:;" class="btlink mlr15 copy_error">点击复制错误信息</a></li>\
          <li style="list-style: none;display:' +
				(isBuy ? 'block' : 'none') +
				'">修复方案三(<span style="color:#ff7300">推荐</span>)：使用微信扫描右侧二维码，联系技术客服。</li>\
        </ul>\
        <div style="position: relative;margin-top: 20px;margin-right: 40px;text-align: center;font-size: var(--el-font-size-small);display:' +
				(isBuy ? 'block' : 'none') +
				'" class="pull-right">\
	...
	ChangePath: function (d) {
		...
		var c = layer.open({
			...
			shadeClose: false,
			content:
				"<div class='changepath'><div class='path-top flex justify-between align-center'><div><button type='button' class='btn btn-default btn-sm' onclick='BackFile()'><span class='glyphicon glyphicon-share-alt'></span> " +
				lan.public.return +
				"</button><div class='place' id='PathPlace'>" +
				lan.bt.path +
				"：<span></span></div></div><button type='button' id='btn_refresh' class='btn btn-default btn-sm'><span class='glyphicon glyphicon-repeat'></span> 刷新</button></div><div class='path-con'><div class='path-con-left'><dl><dt id='changecomlist' onclick='BackMyComputer()'>" +
				lan.bt.comp +
		...
		$.post('/site?action=GetPHPVersion', function (rdata) {
            ...
            <div class="line"><span class="tname">根目录</span>\
              <div class="info-r c4"><input id="inputPath" class="bt-input-text mr5" name="path" value="' +
				default_path +
				'" placeholder="网站根目录" style="width:398px" type="text"><span class="glyphicon glyphicon-folder-open cursor" onclick="bt.select_path(\'inputPath\',\'dir\')"></span> </div>\
            </div>\
	...
	renderAccountAlertView: function (el, callback) {
        ...
        <ul class="help-info-text c7">\
            ...
            <li>当前为体验版,限制每个AdCtira灯塔账号发送频率100条/天</li>\
        </ul>\
        </div>',
			success: function () {
				...
				content:
                  ...
                  <div class="mt10">\
                      <div class="qrcode" style="text-align: center;">\
                          <img src="https://www.adcitra.cn/Public/img/adcitra_wx.jpg" style="width: 180px;"/>\
                      </div>\
                  </div>\
              </div>',
				cancel: function () {
...
var soft = {
	...
	set_soft_config: function (name) {
		...
		bt.soft.get_soft_find(name, function (rdata) {
			...
			var menuing = bt.open({
				...
				shift: 0,
				content:
					'<div class="bt-w-main" style="width:100%;' +
					(name === 'mysqld' ? 'height: 590px;' : name.indexOf('php-') > -1 ? 'height: 600px;' : '') +
					'"><div class="bt-w-menu bt-soft-menu"></div><div id="webEdit-con" class="bt-w-con pd15" style="height:' +
					(name === 'mysqld' ? '100%' : name.indexOf('php-') > -1 ? '600px' : '560px') +
					';overflow:auto"><div class="soft-man-con bt-form"></div></div></div>'
			})
	...
	set_push_config: function (params, callback) {
		bt_tools.send(
			{ url: '/push?action=set_push_config', data: { name: 'site_push', data: JSON.stringify(params), id: Date.now() } },
			function (res) {
...
/* ! AdCtira灯塔文件上传组件 License  https://www.adcitra.cn  */
var bt_upload_file = {
	f: null,
	f_total: 0,
	f_path: null,
	...
	open: function (path, is_exts, ps, collback_to) {
		...
		bt_upload_file._loadT = layer.open({
			type: 1,
			title: '上传文件到[' + bt_upload_file.f_path + ']' + other_ps,
			area: ['550px', '500px'],
			shadeClose: false,
			closeBtn: 2,
			content:
				'<div class="fileUploadDiv"><input type="file" id="file_input" onchange="bt_upload_file.list(this.files)"  multiple="true" autocomplete="off" ' +
				accept_ext +
				' /><button type="button"  id="opt" onclick="$(\'#file_input\').click()" autocomplete="off">选择文件</button>' +
				btn_dir +
				'<span id="totalProgress" style="position: absolute;top: 7px;right: 10px;"></span><span><button type="button" id="up" autocomplete="off" onclick="bt_upload_file.start(0)">开始上传</button><button type="button" id="filesClose" autocomplete="off" onClick="layer.close(bt_upload_file._loadT)" >关闭</button></span><ul id="up_box"><li id="tipsUpdataText" style="height: 97%;line-height: 280px;text-align: center;color: #ccc;font-size: 32px;"><span>请将需要上传的文件拖到此处</span></li></ul></div>'
		})
		...
		var area = document.getElementById('up_box')
		area.addEventListener('drop', function (e) {
			...
			bt_upload_file.list(fileList)
		})
	},
	list: function (_files) {
		$('#totalProgress').html('')
		$('#tipsUpdataText').remove()
		if (_files.length == 0) {
			return false
		}
		var file_data = $.extend(true, {}, _files)
		for (var i = 0; i < file_data.length; i++) {
			bt_upload_file._files.push(file_data[i])
		}
		var fileList = bt_upload_file._files
		$('#up_box').html('')
		var loadT = layer.msg('正在加载文件列表...', { time: 0, icon: 16, shade: 0.3 })
		for (var i = 0; i < fileList.length; i++) {
			var f_name = fileList[i].name
			if (fileList[i].webkitRelativePath) {
				f_name = fileList[i].webkitRelativePath
			}
			$('#up_box').append(
				'<li class="offset-' + i + '"><span class="filename" title="上传到: ' + bt_upload_file.f_path + '/' + f_name + '">' + f_name + '</span><span class="filesize">' + bt_upload_file.to_size(fileList[i].size) + '</span><em>等待上传</em></li>'
			)
		}
		layer.close(loadT)
	},
		...
		$.ajax({
			...
			success: function (data) {
				if (typeof data === 'number') {
					...
					$('#up_box li .filesize')[i].outerHTML = '<span class="filesize">' + bt_upload_file.to_size(data) + '/' + bt_upload_file.to_size(bt_upload_file.f.size) + '</span>'
					...
					if (data.status) {
						...
						$('#up_box li .filesize')[i].outerHTML = '<span class="filesize">' + bt_upload_file.to_size(bt_upload_file.f.size) + '/' + bt_upload_file.to_size(bt_upload_file.f.size) + '</span>'
					} else {
