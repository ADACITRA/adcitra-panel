...
def get_malicious_ip(page = 1):
    ...
    url = "https://www.adcitra.cn/api/bt_waf/get_system_malicious?x_bt_token=SksBSpWhJE7oVRixKCAZVEsN3QDnfQBU&page={}&size={}&uid={}&serverid={}&access_key={}".format(page,page_size,userinfo['uid'], userinfo['serverid'], userinfo['access_key'])
...
def get_ban_time():
    ...
    """
    ban_time = 1
    firewall_config = public.readFile("/www/adcitra/panel/config/firewall_config.json")
    if firewall_config:
