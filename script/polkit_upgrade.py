...
import public
upgrade_log_file = '/www/adcitra/panel/logs/upgrade_polkit.log'
...
def check():
    tip_file = '/www/adcitra/panel/data/upgrade_polkit.pl'
...
if __name__ == "__main__":
    tip_file = '/www/adcitra/panel/data/upgrade_polkit_run.pl'
    if os.path.exists(tip_file):
        print("程序正在运行中,退出!")
        sys.exit(1)
