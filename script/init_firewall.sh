...
create_systemd_service() {
    local exec_path="/www/adcitra/panel/pyenv/bin/python3 /www/adcitra/panel/script/AdCtira-FirewallServices.py"
    local service_file="/etc/systemd/system/BT-FirewallServices.service"
    if [ ! -f "$service_file" ]; then
        /www/adcitra/panel/pyenv/bin/python3 -c "import os,sys; os.chdir('/www/adcitra/panel/'); sys.path.insert(0, 'class/'); sys.path.insert(0, '/www/adcitra/panel/'); import public; public.stop_syssafe();"
...
EOF
        ...
        /www/adcitra/panel/pyenv/bin/python3 -c "import os,sys; os.chdir('/www/adcitra/panel/'); sys.path.insert(0, 'class/'); sys.path.insert(0, '/www/adcitra/panel/'); import public; public.start_syssafe();"
    else
