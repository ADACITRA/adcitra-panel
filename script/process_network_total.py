...
try:
    ...
    # 标记只安装一次
    tip_file = '/www/adcitra/panel/install/check/tip.json'
        ...
        if os.path.exists('/usr/bin/apt'):
            ...
            if os.path.exists(red_file):
                ...
                if red_body.find('CentOS Linux release 8.') != -1:
                    ...
                    down_url = "wget -O {} https://download.adcitra.cn/src/libpcap-devel-1.9.1-5.el8.x86_64.rpm --no-check-certificate -T 10".format(rpm_file)
