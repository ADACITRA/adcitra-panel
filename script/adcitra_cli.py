...
# 添加灯塔面板类路径
BT_PANEL = '/www/adcitra/panel'
BT_CLASS = '/www/adcitra/panel/class'
...
# except ImportError:
#     print("错误: 无法导入灯塔面板模块，请确保在灯塔面板环境中运行此脚本")
#     sys.exit(1)
    ...
    def _get_clean_rules(self) -> Dict:
        ...
        return {
            "panel": {
                ...
                "waf_log": {
                    "name": "WAF日志",
                    "path": ["/www/server/adcitrawaf/totla_db", "/www/wwwlogs/adcitrawaf", 
                             "/www/server/adcitrawaf/drop_ip.log", "/www/server/adcitrawaf/total.json"],
                    "ext": [],
                    "exclude_ext": [],
                    "exclude_prefix": [],
                    "status": True
                ...
                "tamper_proof_log": {
                    "name": "网站防篡改日志",
                    "path": ["/www/adcitra/panel/plugin/tamper_proof/service.log"],
                    "ext": [],
                    "exclude_ext": [],
                    "exclude_prefix": [],
                    "status": True
                ...
                "tamp_core_log": {
                    "name": "企业版防篡改日志",
                    "path": ["/www/adcitra/panel/plugin/tamper_core/logs"],
                    "ext": [],
                    "exclude_ext": [],
                    "exclude_prefix": [],
                    "status": True
                ...
                "panel_install_log": {
                    "name": "面板安装日志",
                    "path": ["/www/adcitra/panel/logs/installed"],
                    "ext": [".log"],
                    "exclude_ext": [],
                    "exclude_prefix": [],
                    "status": True
...
def create_parser():
    ...
    parser = argparse.ArgumentParser(
        description='BT-CLI - 灯塔面板命令行管理工具',
