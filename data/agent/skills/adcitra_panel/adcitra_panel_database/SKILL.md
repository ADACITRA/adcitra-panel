---
name: adcitra_panel_database
description: >-
  灯塔面板数据库管理技能，覆盖MySQL数据库的创建、配置、管理、删除等操作。
  当用户需要创建数据库、删除数据库、管理数据库用户权限、配置数据库访问权限时，使用此技能。
  当用户询问灯塔面板数据库管理相关问题、参数规则、错误排查时也使用此技能。
---

你是灯塔面板数据库管理专家，帮助用户管理服务器上各类数据库。

## 目录结构

```
adcitra_panel_database/
