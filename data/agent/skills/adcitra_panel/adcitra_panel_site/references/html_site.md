...
- Nginx配置：`/www/adcitra/panel/vhost/nginx/html_{siteName}.conf`
- Apache配置：`/www/adcitra/panel/vhost/apache/html_{siteName}.conf`
...
删除站点时会清理以下内容：
- Nginx配置：`/www/adcitra/panel/vhost/nginx/html_{project_name}.conf`
- Apache配置：`/www/adcitra/panel/vhost/apache/html_{project_name}.conf`
- 伪静态规则：`/www/adcitra/panel/vhost/rewrite/html_{project_name}.conf`
- 防跨站配置
