...
class main(safeBase):
    __path = '/www/adcitra/panel/data/warning_report'
    __risk = __path + '/risk'
    __data = __path + '/data.json'
    new_result = "/www/adcitra/panel/data/warning/resultresult.json"
    data = []
    final_obj = {}
    all_cve = 0
    cve_num = 0
    ...
    def get_report(self, get):
        ...
        # if os.path.exists("/www/adcitra/panel/data/warning/result.json"):
        #     with open("/www/adcitra/panel/data/warning/result.json") as f:
