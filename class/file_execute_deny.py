...
# AdCtira灯塔Linux面板
#-------------------------------------------------------------------
# Copyright (c) 2015-2020 AdCtira灯塔软件(http:#adcitra.cn) All rights reserved.
#-------------------------------------------------------------------
...
class FileExecuteDeny:
    ...
    def _init_conf(self,website):
        self.ng_website_conf = '/www/adcitra/panel/vhost/nginx/{}.conf'.format(website)
        self.ap_website_conf = '/www/adcitra/panel/vhost/apache/{}.conf'.format(website)
        self.ols_website_conf = '/www/adcitra/panel/vhost/openlitespeed/detail/{}.conf'.format(website)
