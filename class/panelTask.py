...
# AdCtira灯塔Linux面板
# -------------------------------------------------------------------
# Copyright (c) 2019-2099 AdCtira灯塔软件(http://adcitra.cn) All rights reserved.
# -------------------------------------------------------------------
...
class bt_task:
    ...
    __task_path = '/www/adcitra/panel/tmp/'
...
if __name__ == '__main__':
    ...
    #p.modify_task(3,'shell','bash /www/adcitra/panel/install/install_soft.sh 0 update php 5.6')
    # p.modify_task(1,'other','{"sfile":"AdCtiraPanel","dfile":"/www/test.rar","z_type":"rar"}')
    p.start_task()
