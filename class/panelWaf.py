...
flag_file='/www/adcitra/panel/data/tmp1.json'
...
try:
    ...
    if os.path.exists('/www/adcitra/panel/pyenv/bin/python3'):
        public.ExecShell('/www/adcitra/panel/pyenv/bin/pip install Cython')
        public.ExecShell('/www/adcitra/panel/pyenv/bin/pip install libinjection-python')
    else:
