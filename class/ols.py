...
class ols:
    ...
    _detail_conf_path = '/www/adcitra/panel/vhost/openlitespeed/detail/{}.conf'
...
"""
    ...
    def _get_need_create_site(self):
        ...
        data = []
        for s in siteinfo:
            path = '/www/adcitra/panel/vhost/openlitespeed/{}.conf'.format(s['sitename'])
    ...
    def _get_siteconf_info(self):
        ...
        rundir_reg = r'root\s+(.*);'
        for s in siteinfo:
            path = '/www/adcitra/panel/vhost/nginx/{}.conf'.format(s['sitename'])
            conf = public.readFile(path)
            ap_path = '/www/adcitra/panel/vhost/apache/{}.conf'.format(s['sitename'])
