...
'''
    ...
    def set_config(self, project_find):
        ...
        if not conf:
            ...
            well_known_file = "/www/adcitra/panel/vhost/nginx/well-known/{}.conf".format(project_name)
    ...
    def get_waf_status_all(self, names):
        ...
        try:
            ...
            config_path = '/www/server/adcitrawaf/config.json'
