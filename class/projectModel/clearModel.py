...
from AdCtiraPanel import cache #line:8
class main (projectBase ):#line:10
    __O000OO000OOOOOO00 =public .Md5 ('clear'+time .strftime ('%Y-%m-%d'))#line:11
    __OOOO0O0OOO00O0O0O ='/www/adcitra/panel/config/clear_log.json'#line:12
    __OO000OOOOO0OOO0OO ='/www/adcitra/panel/data/clear'#line:13
    ...
    def get_config (O0OO0O00OOOOO00OO ):#line:30
        ...
        if not cache .get (O0OO0O00OOOOO00OO .__O000OO000OOOOOO00 ):#line:45
            try :#line:46
                ...
                O00OOOOO0O0O00000 =requests .get ("https://www.adcitra.cn/api/bt_waf/clearLog").json ()#line:48
