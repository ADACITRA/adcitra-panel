...
class main(projectBase):
    __config_file = '/www/adcitra/panel/config/java_cve_scanning.json'
    __path='/www/adcitra/panel/class/projectModel/vlu'
    ...
    def sync_update_rule(self,get):
        "更新规则库"
        url="https://download.adcitra.cn/adcitrawaf_rule/vlu/"
        import requests
        result={}
        try:
