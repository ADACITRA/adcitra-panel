...
class main:
    ...
    def commit(self, args):
        ...
        if hasattr(args, "path") and args.path:
            ...
            import projectModel.adcitra_docker.dk_image as dk
    ...
    def get_other_data_for_container_list(self, args):
        import projectModel.adcitra_docker.dk_image as di
        import projectModel.adcitra_docker.dk_volume as dv
        import projectModel.adcitra_docker.dk_compose as dc
        import projectModel.adcitra_docker.dk_setup as ds
        # 获取镜像列表
