...
import json
import public
import projectModel.adcitra_docker.dk_public as dp
...
class main:
    ...
    def set_docker_monitor(self, args):
        ...
        cmd_line = "/www/adcitra/panel/class/projectModel/adcitra_docker/dk_monitor.py"
        if args.act == "start":
    ...
    def install_docker_program(self, args):
        ...
        # Docker_Install_File = "/www/adcitra/panel/install/docker_install.sh"
        # execstr = "wget -O {} http://download.adcitra.cn/install/0/docker_install.sh -T 5"
        execstr = "/bin/bash /www/adcitra/panel/install/install_soft.sh 0 install docker_install"
