...
class ssh_authentication:
    ...
    __config_pl='/www/adcitra/panel/data/pam_btssh_authentication.pl'
    ...
    def install_pam_python(self,check):
        ...
        public.ExecShell('/usr/local/curl/bin/curl -o %s %s/adcitrawaf_rule/pam_python_so/%s'%(so_path,public.get_url(),so_name))
    ...
    def get_pin(self):
        ...
        ip_list = public.ReadFile('/www/adcitra/panel/data/pam_btssh_authentication.pl')
        ret = {}
