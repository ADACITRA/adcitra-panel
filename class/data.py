...
class data:
    ...
    siteorder_path = '/www/adcitra/panel/data/siteorder1.pl'
    limit_path = '/www/adcitra/panel/data/limit1.pl'
    '''
     * 设置备注信息
    ...
    def get_waf_status_all(self):
        ...
        data = {}
        try:
            path = '/www/server/adcitrawaf/site.json'
    ...
    def getData(self, get):
        try:
            ...
            net_flow_json_file = "/www/adcitra/panel/plugin/total/panel_net_flow.json"
            if get.table == 'sites':
    ...
    def GetSql(self, get, result='1,2,3,4,5,8'):
        ...
        mysql_auto_status = "/www/adcitra/panel/data/is_sqlist.pl"
    ...
    def get_https_port(self, get):
        try:
            ...
            if os.path.exists('/www/adcitra/panel/vhost/nginx/{}.conf'.format(get.siteName)):
                conf = public.readFile('/www/adcitra/panel/vhost/nginx/{}.conf'.format(get.siteName))
    ...
    def set_https_port(self, get):
        ...
        conf_tmp= os.path.abspath('/www/adcitra/panel/vhost/nginx/{}.conf'.format(get.siteName))
        if not conf_tmp.startswith('/www/adcitra/panel/vhost/nginx/'):
        ...
        if not os.path.exists('/www/adcitra/panel/vhost/nginx/{}.conf'.format(get.siteName)):
        ...
        public.writeFile('/www/adcitra/panel/vhost/nginx/{}.conf'.format(get.siteName), conf)
        apa_conf = public.readFile('/www/adcitra/panel/vhost/apache/{}.conf'.format(get.siteName))
        if apa_conf and public.get_webserver() == "apache":
            ...
            public.writeFile('/www/adcitra/panel/vhost/apache/{}.conf'.format(get.siteName), apa_conf)
