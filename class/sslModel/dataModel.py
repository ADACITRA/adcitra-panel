...
from AdCtiraPanel import project
...
class main(sslBase):
    ...
    #
    #     # 根据文件修改时间判断是否要同步
    #     check_path = "/www/adcitra/panel/data/sync_domains.pl"
    #     m_time = str(os.stat("/www/adcitra/panel/data/db/site.db").st_mtime)
    #     check_path_docker = "/www/adcitra/panel/data/sync_domains_docker.pl"
    #     m_time_docker = str(os.stat("/www/adcitra/panel/data/db/docker.db").st_mtime)
