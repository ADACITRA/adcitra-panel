...
class main(sslBase):
    ...
    # __APIURL2 = "https://dev.adcitra.cn" + '/api/v2/synchron'
    __PDATA = None
    _check_url = None
    __request_url = None
    ...
    def plane_synchron_access_set(self, get):
        ...
        # self.__PDATA["url"] = "https://www.adcitra.cn"
...
if __name__ == '__main__':
    try:
        if os.path.exists("/www/adcitra/panel/data/auto_deploy.pl"):
            exit()
        public.writeFile("/www/adcitra/panel/data/auto_deploy.pl", "")
        m = main()
        import argparse
        ...
        os.remove("/www/adcitra/panel/data/auto_deploy.pl")
