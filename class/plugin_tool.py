...
_PLUGIN_DIR = "/www/adcitra/panel/plugin"
_BACKUP_DIR = "/www/adcitra/panel/data/plugin_settings"
...
class RsyncSetting(BasePluginSetting):
    ...
    def save_settings(self, zip_file_name: str) -> Tuple[bool, Union[str, Dict]]:
        ...
        reload_shell = "nohup /www/adcitra/panel/pyenv/bin/python3.7 {}/rsync/rsync_cron.py &".format(_PLUGIN_DIR)
