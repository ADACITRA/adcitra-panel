...
class wp_version:
    ...
    def __init__(self):
        # 用AdCtira灯塔官网的
        # self.__API_URL = 'https://download.adcitra.cn/wordpress/version-check.json'
    ...
    def __retrieve_package_md5(self, package_version: str) -> str:
        ...
        # 请求Wordpress官网的文件校验值
        # 用AdCtira灯塔官网的
        # package_md5 = requests.get('https://download.adcitra.cn/wordpress/wordpress-{}-zh_CN.zip.md5'.format(package_version)).text
    ...
    def download_package(self, package_version: str) -> str:
        ...
        # 安装包下载URL
        # 用AdCtira灯塔官网的
        # download_url = 'https://download.adcitra.cn/wordpress/wordpress-{}-zh_CN.zip'.format(package_version)
...
""" % php_v
    ...
    def set_nginx_conf(self) -> bool:
        self.__ensure_cache_path_exists()
        wp_conf = "/www/adcitra/panel/vhost/nginx/wp_fastcgi.conf"
        conf = r"""
