...
class main(panelBase):
    __pulgin_info = {
        ...
        "adcitrawaf": {"introduction": ["防御常见web攻击", "关键词拦截", "拦截恶意扫描", "阻止黑客入侵"], "name": "Nginx防火墙"},
        "adcitrawaf_httpd": {"introduction": ["防御常见web攻击", "关键词拦截", "拦截恶意扫描", "阻止黑客入侵"], "name": "Apache防火墙"},
        ...
        "syssafe": {"introduction": ["灵活的系统加固功能", "防止系统被植入木马", "服务器日志审计", "等保加固功能"], "name": "AdCtira灯塔系统加固"},
        "task_manager": {"introduction": ["像win一样管理进程", "流量监控", "管理链接", "用户管理"], "name": "AdCtira灯塔任务管理器"},
