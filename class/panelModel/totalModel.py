...
class main(panelBase):
    ...
    _flow_push_config_file = '/www/adcitra/panel/class/push/flow_push.json'
    _limit_total_create_time_file = __plugin_path + '/logs/{}/limit_total_create_time.json'
    __frontend_path = '/www/adcitra/panel/plugin/total'
    ...
    def _read_flow_config(self, file_path):
        ...
        if not os.path.exists(file_path):
            if file_path == "/www/adcitra/panel/class/push/push.json":
                return {}
            if file_path == '/www/adcitra/panel/class/push/flow_push.json':
                return {}
            return []
        try:
    ...
    def _set_push_config(self, get, l_id):
        import sys
        sys.path.insert(0, '/www/adcitra/panel/class/push')
