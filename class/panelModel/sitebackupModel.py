...
class SiteBackup(object):
    ...
    def backup_redirect(self):
        ...
        nginx_redirect = '/www/adcitra/panel/vhost/nginx/redirect/%s/' % self.site_name
        ...
        apache_redirect = '/www/adcitra/panel/vhost/apache/redirect/%s/' % self.site_name
        ...
        redirect_conf = '/www/adcitra/panel/data/redirect.conf'
    ...
    def backup_proxy(self):
        ...
        nginx_proxy = '/www/adcitra/panel/vhost/nginx/proxy/%s/' % self.site_name
    ...
    def backup_rewrite(self):
        ...
        nginx_rewrite = '/www/adcitra/panel/vhost/rewrite/%s.conf' % self.site_name
    ...
    def backup_dir_auth(self):
        ...
        nginx_dir_auth = '/www/adcitra/panel/vhost/nginx/dir_auth/%s/' % self.site_name
        ...
        apache_dir_auth = '/www/adcitra/panel/vhost/apache/dir_auth/%s/' % self.site_name
        ...
        dir_auth_conf = '/www/adcitra/panel/data/site_dir_auth.json'
    ...
    def backup_well_known(self):
        ...
        nginx_well_known = '/www/adcitra/panel/vhost/nginx/well-known/%s.conf' % self.site_name
    ...
    def backup_nginx_conf(self):
        ...
        nginx_conf = '/www/adcitra/panel/vhost/nginx/%s.conf' % self.site_name
    ...
    def backup_apache_conf(self):
        ...
        apache_conf = '/www/adcitra/panel/vhost/apache/%s.conf' % self.site_name
        if os.path.exists(apache_conf):
            public.ExecShell('\cp -r %s %s' % (apache_conf, back_apache))

    def backup_ssl(self):
        back_ssl = self._backup_path + "/cert/"
        ssl_path = '/www/adcitra/panel/vhost/cert/%s/' % self.site_name
