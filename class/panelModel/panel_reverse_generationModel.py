...
#         filename = '/www/adcitra/panel/vhost/apache/' + self.siteName + '.conf'
...
# }}
#     '''.format(port=self.__port, domain=self.siteName)
#         filename = '/www/adcitra/panel/vhost/nginx/' + self.siteName + '.conf'
#         public.writeFile(filename, conf)
#
...
#             if not os.path.exists('/www/adcitra/panel/vhost/ssl/{}'.format(cert_name)):
#                 return public.returnMsg(False, '证书不存在!')
#             cert_data = {}
#             cert_data['cert_name'] = cert_name
#             cert_data['cert'] = public.readFile('/www/adcitra/panel/vhost/ssl/{}/fullchain.pem'.format(cert_name))
#             cert_data['key'] = public.readFile('/www/adcitra/panel/vhost/ssl/{}/privkey.pem'.format(cert_name))
#             cert_data['info'] = json.loads(
#                 public.readFile('/www/adcitra/panel/vhost/ssl/{}/info.json'.format(cert_name)))
#             return cert_data
#         except:
#             return traceback.format_exc()
#
...
#                     data['cert'] = public.readFile('/www/adcitra/panel/ssl/certificate.pem')
#                     data['key'] = public.readFile('/www/adcitra/panel/ssl/privateKey.pem')
#                 return data
#             else:
#                 return {
#                     'proxy_stats': False,
...
#         public.ExecShell('rm -rf /www/adcitra/panel/vhost/nginx/' + data['domain'] + '.conf')
#         public.ExecShell('rm -rf /www/adcitra/panel/vhost/apache/' + data['domain'] + '.conf')
...
#             siteName = get.domain
#         else:
#             data = json.loads(public.readFile('/www/adcitra/panel/data/panel_generation.pl'))
...
#             flag = 0
#             get.certPem = public.readFile('/www/adcitra/panel/ssl/certificate.pem')
#         if not hasattr(get, 'privateKey') or not get.privateKey:
#             flag = 0
#             get.privateKey = public.readFile('/www/adcitra/panel/ssl/privateKey.pem')
#         if flag:
