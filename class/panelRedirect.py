...
# AdCtira灯塔Linux面板
#-------------------------------------------------------------------
# Copyright (c) 2015-2018 AdCtira灯塔软件(http:#adcitra.cn) All rights reserved.
#-------------------------------------------------------------------
# Author: hwliang <hwl@adcitra.cn>
# Author: hezhihong <272267659@adcitra.cn>
#-------------------------------------------------------------------
...
class panelRedirect:
    ...
    def unset_nginx_conf(self,site_name):
        ...
        @param site_name 站点名称
        """
        file_path='/www/adcitra/panel/vhost/nginx/{}.conf'.format(site_name)
        hta_path='/www/adcitra/panel/vhost/rewrite/{}.conf'.format(site_name)
