...
class main(dockerBase):
        ...
        if public.M('sqlite_master').db('docker_log_split').where('type=? AND name=?', ('table', 'docker_log_split')).count():
            ...
            if add_crond:
                get = {
                    ...
                    "backupTo": "localhost",
                    "save": '',
                    "sBody": "btpython /www/adcitra/panel/script/dk_log_split.py",
    ...
    def commit(self, get):
        ...
        try:
            ...
            if hasattr(get, "path") and get.path:
                ...
                from adcitraDockerModel import imageModel as di
    ...
    def del_container(self, get):
        ...
        from adcitraDockerModel.proxyModel import main
    ...
    def set_container_to_top(self, get):
        ...
        _conf_path = "{}/class/adcitraDockerModel/config/container_top.json".format(public.get_panel_path())
