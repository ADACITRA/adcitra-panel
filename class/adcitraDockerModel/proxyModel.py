...
class main(dockerBase):
    ...
    def get_proxy_info(self, get):
        ...
        container_id = get.container_id
        from adcitraDockerModel import containerModel as dc
        get.id = container_id
        ...
        try:
            ...
            path = '/www/adcitra/panel/vhost/cert/' + proxy_info['name']
            conf_file = '/www/adcitra/panel/vhost/nginx/' + proxy_info['name'] + '.conf'
