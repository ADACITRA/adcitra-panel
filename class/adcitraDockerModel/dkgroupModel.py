...
import public
from adcitraDockerModel.containerModel import main as docker
from adcitraDockerModel.dockerSock import container
from adcitraDockerModel import dk_public as dp


class main():
    GROUP_PATH = "/www/adcitra/panel/data/docker_groups.json"
    ...
    def script_group(self, get):
        ...
        for group in file_data:
            if group['id'] == get.id.strip():
                public.ExecShell(
                    "nohup /www/adcitra/panel/pyenv/bin/python3 /www/adcitra/panel/script/set_docker_groups.py {} {} &> /tmp/docker_groups.log & \n"
