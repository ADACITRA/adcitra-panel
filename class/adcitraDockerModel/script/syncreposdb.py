#!/www/adcitra/panel/pyenv/bin/python3.7
# coding: utf-8
# -------------------------------------------------------------------
# AdCtira灯塔Linux面板
# -------------------------------------------------------------------
...
import public
import adcitraDockerModel.dk_public as dp

db_file = '{}/class/adcitraDockerModel/config/docker_hub_repos.db'.format(public.get_panel_path())
last_update_pl = "{}/class/adcitraDockerModel/config/docker_hub_last_update.pl".format(public.get_panel_path())
