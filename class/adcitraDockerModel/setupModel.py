...
from adcitraDockerModel.dockerBase import dockerBase
...
class main(dockerBase):
    ...
    def get_config(self, get):
        ...
        if not os.path.exists("/www/adcitra/panel/data/db/docker.db"):
            public.ExecShell("mv -f /www/adcitra/panel/data/docker.db /www/adcitra/panel/data/db/docker.db")
        ...
        # try:
        #     bad_registry = os.path.exists("/www/adcitra/panel/config/bad_registry.pl")
        #     bad_registry_path = public.readFile("/www/adcitra/panel/config/bad_registry.pl")
    ...
    def _get_com_registry_mirrors():
        ...
        @return:
        """
        com_reg_mirror_file = "{}/class/adcitraDockerModel/config/com_reg_mirror.json".format(public.get_panel_path())
        try:
    ...
    def get_service_status(self):
        ...
        # Nas镜像标识文件
        tagfile = "/www/adcitra/panel/data/o.pl"
    ...
    def set_docker_monitor(self, get):
        ...
        """
        import time
        python = "/www/adcitra/panel/pyenv/bin/python"
        if not os.path.exists(python):
            python = "/www/adcitra/panel/pyenv/bin/python3"
        cmd_line = "/www/adcitra/panel/class/adcitraDockerModel/monitorModel.py"
        if get.act == "start":
    ...
    def stop_monitor(self, get):
        ...
        '''
        cmd_line = [
            "/www/adcitra/panel/class/adcitraDockerModel/monitorModel.py",
            "/www/adcitra/panel/class/projectModel/adcitra_docker/dk_monitor.py"
        ]
...
if [ -f {} ]; then
    ...
    if [ -z "$new_mt" ] && [ -z "$old_mt" ]; then
        nohup /www/adcitra/panel/pyenv/bin/python /www/adcitra/panel/class/adcitraDockerModel/monitorModel.py &
    fi
fi
    ...
    def check_docker_compose_service(self):
        ...
        docker_compose_path = "{}/class/adcitraDockerModel/config/docker_compose_path.pl".format(public.get_panel_path())
        ...
        if url == "":
            ...
            if c_flag != "0":
                if c_flag == "2":
                    ...
                    url_file = "/www/adcitra/panel/class/adcitraDockerModel/config/install_url.pl"
    ...
    def uninstall_status(get):
        ...
        """
        # 获取容器
        from adcitraDockerModel import containerModel
        docker_list = containerModel.main().get_list(get)
        # 获取镜像
        from adcitraDockerModel import imageModel
    ...
    def get_system_info(self, get):
        '''
            @name 获取系统信息
        '''
        from adcitraDockerModel.dockerSock.system import dockerSystem
        import psutil
    ...
    def set_dk_project_path(self,get):
        ...
        project_path_file = "{}/class/adcitraDockerModel/config/project_path.pl".format(public.get_panel_path())
