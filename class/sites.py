...
{
    listen 80;
    server_name huang.adcitra.cn bt001.adcitra.cn;
    index index.php index.html index.htm default.php default.htm default.html;
    root /www/wwwroot/huang.adcitra.cn;
    ...
    include /www/adcitra/panel/vhost/rewrite/huang.adcitra.cn.conf;
    #REWRITE-END
    ...
    access_log  /www/wwwlogs/huang.adcitra.cn.log;
    error_log  /www/wwwlogs/huang.adcitra.cn.error.log;
};'''
    ...
    def _generate_nginx_conf(self,siteName):
        ...
        siteConfig = {
	                    ...
	                    "antiStealingLink": {
		                    ...
		                    "domains": ["www.adcitra.cn", "adcitra.cn"],
		                    "code": 404
	                    },
	                    "networkLimit": {
		                    "open": False,
