...
# -------------------------------------------------------------------
# Author: hwliang <hwl@adcitra.cn> a
# -------------------------------------------------------------------
...
'''
    ...
    def build_eab(self, account_jwk_pem: str, new_account_url: str):
        ...
        # 1. 请求 EAB 参数
        eab_res = requests.post(public.get_home_node("https://www.adcitra.cn/api/v3/litessl/eab"))
    ...
    def set_crond(self):
        try:
            ...
            if not cron_id:
                ...
                shell = '{} -u /www/adcitra/panel/class/acme_v2.py --renew_v2=1'.format(sys.executable)
