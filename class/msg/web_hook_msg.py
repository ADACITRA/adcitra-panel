...
class HooKConfig(object):
    ...
    def get_version_info():
        ...
        """
        data = {
            'ps': 'AdCtira灯塔WEB HOOK消息通道，用于接收面板消息推送',
            'version': '1.0',
            'date': '2023-10-30',
            'author': 'AdCtira灯塔',
            'title': 'WEB HOOK',
...
class web_hook_msg:
    ...
    def send_msg(self, msg, title: str = '灯塔面板消息推送', push_type: str = 'unknown'):
        """
        触发web_hook, 发送信息
        """
