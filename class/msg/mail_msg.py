...
class mail_msg:
    ...
    __mail_send_conf = '/www/adcitra/panel/data/stmp_mail.json'
    __mail_receive_conf = '/www/adcitra/panel/data/mail_list.json'
    __mail_config = None
    def __init__(self):
        self.__mail_config = {}
    ...
    def get_version_info(self,get):
        ...
        """
        data = {}
        data['ps'] = 'AdCtira灯塔邮箱消息通道，用于接收面板消息推送'
        data['version'] = '1.1'
    ...
    def set_config(self,get):
        ...
        ret = self.send_msg("AdCtira灯塔测试邮件")
        if ret['status']:
    ...
    def send_msg(self,msg , title = '灯塔面板消息推送',to_email = None):
        """
        邮箱发送
        @msg 消息正文
        @title 消息标题
