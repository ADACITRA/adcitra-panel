...
class main(projectBase):
    ...
    def create(self, args):
        try:
            ...
            #         res = public.readFile('/www/adcitra/panel/plugin/syssafe/config.json')
            #         if res:
            #             res = json.loads(res)
            #             if res['open'] == True:
    ...
    def create_task(self, pdata):
        pypath = '/www/adcitra/panel/class/monitorModel/boceModel.py'
        p = crontab.crontab()
        args = {
    ...
    def send_notification(self, title, msg):
        if self.sql_data['alarm_count'] > 0:
            if os.path.exists("/www/adcitra/panel/data/boce_alam.json"):
                boce_alam = json.loads(public.readFile("/www/adcitra/panel/data/boce_alam.json"))
            else:
                boce_alam = {}
            import datetime
            ...
            public.writeFile("/www/adcitra/panel/data/boce_alam.json", json.dumps(boce_alam))
