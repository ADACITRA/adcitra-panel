...
class main:
    ...
    def add_crontab(self, cycle: int):
        ...
        :return:
        """
        pypath = '/www/adcitra/panel/script/site_log_push.py'
        p = crontab.crontab()
        args = {
            "name": "[勿删]网站日志关键字告警任务",
            "type": "minute-n",
            ...
            "backupTo": "localhost",
            "save": '',
            "sBody": "btpython {} >> {} 2>&1".format(pypath, '/www/adcitra/panel/logs/site_log_psuh.log'),
    ...
    def get_site_log_push(self, get: None):
        ...
        if os.path.exists('/www/adcitra/panel/config/site_log_push.json'):
            data = json.loads(open('/www/adcitra/panel/config/site_log_push.json').read())
        return data
    ...
    def set_push_task(self, get):
        ...
        try:
            ...
            public.writeFile('/www/adcitra/panel/config/site_log_push.json', json.dumps(old_data))
    ...
    def get_logs(self, get=None):
        log_path = '/www/adcitra/panel/logs/site_log_psuh.log'
