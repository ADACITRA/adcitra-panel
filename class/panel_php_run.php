...
class bt_panel_plugin
{
	...
	private function init(){
		...
		//初始化插件配置
		define('PLU_PATH', '/www/adcitra/panel/plugin/'.trim($args_arr['plugin_name']));
...
{
	function __construct($db_file = '/www/adcitra/panel/data/default.db')
    {
        $this->open($db_file);
    }
...
function _version(){
	$comm_body = file_get_contents('/www/adcitra/panel/class/common.py');
...
function _httpGet($url) {
	...
	curl_setopt($ch, CURLOPT_USERAGENT, "AdCtira-Panel for PHP-Plugin");
