...
def setup_idc():
    try:
        ...
        if os.path.exists(tFile):
            ...
            if title == 'AdCtira灯塔Linux面板' or title == '': public.writeFile(tFile,titleNew)
        else:
...
def get_temp_login():
    ...
    if public.M('temp_login').insert(pdata):
        ...
        IP_ADDRES=public.ExecShell("curl -sS --connect-timeout 10 -m 20 https://www.adcitra.cn/Api/getIpAddress")[0]
