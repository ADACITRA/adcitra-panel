...
class wxapp():
    ...
    def __init__(self):
        self.app_path = '/www/adcitra/panel/data/'
        self.app_path_p = '/www/adcitra/panel/plugin/app/'
    ...
    def login_qrcode(self, get):
        ...
        qrcode_str = 'https://app.adcitra.cn/app.html?&panel_url='+public.getPanelAddr()+'&v=' + public.GetRandomString(3)+'?login&tid=' + tid
    ...
    def check_app_login(self,get):
        # 判断是否存在绑定
        btapp_info = json.loads(public.readFile('/www/adcitra/panel/config/api.json'))
