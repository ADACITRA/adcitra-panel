...
'''
增加
先添加/www/adcitra/panel/data/libList.conf文件中的信息
...
class qiniu:
    ...
    def __init__(self):
        if not '/www/adcitra/panel/plugin/qiniu' in sys.path:
            sys.path.insert(0, '/www/adcitra/panel/plugin/qiniu')
        try:
...
class tianyiyun:
    ...
    def __init__(self):
        if not '/www/adcitra/panel/plugin/tianyiyun' in sys.path:
            sys.path.insert(0, '/www/adcitra/panel/plugin/tianyiyun')
        try:
...
class bos:
    ...
    def __init__(self):
        if not '/www/adcitra/panel/plugin/bos' in sys.path:
            sys.path.insert(0, '/www/adcitra/panel/plugin/bos')
        try:
...
class cos:
    ...
    def __init__(self):
        if not '/www/adcitra/panel/plugin/txcos' in sys.path:
            sys.path.insert(0, '/www/adcitra/panel/plugin/txcos')
        try:
...
class upyun:
    ...
    def __init__(self):
        if not '/www/adcitra/panel/plugin/upyun' in sys.path:
            sys.path.insert(0, '/www/adcitra/panel/plugin/upyun')
        try:
...
class alioss:
    ...
    def __init__(self):
        if not '/www/adcitra/panel/plugin/alioss' in sys.path:
            sys.path.insert(0, '/www/adcitra/panel/plugin/alioss')
        try:
...
class gdrive:
    ...
    def __init__(self):
        if not '/www/adcitra/panel/plugin/gdrive' in sys.path:
            sys.path.insert(0, '/www/adcitra/panel/plugin/gdrive')
        try:
...
class aws_s3:
    ...
    def __init__(self):
        if not '/www/adcitra/panel/plugin/aws_s3' in sys.path:
            sys.path.insert(0, '/www/adcitra/panel/plugin/aws_s3')
        try:
...
class gcloud_storage:
    ...
    def __init__(self):
        if not '/www/adcitra/panel/plugin/gcloud_storage' in sys.path:
            sys.path.insert(0, '/www/adcitra/panel/plugin/gcloud_storage')
        try:
...
class obs:
    ...
    def __init__(self):
        if not '/www/adcitra/panel/plugin/obs' in sys.path:
            sys.path.insert(0, '/www/adcitra/panel/plugin/obs')
        try:
...
class msonedrive:
    ...
    def __init__(self):
        if not '/www/adcitra/panel/plugin/msonedrive' in sys.path:
            sys.path.insert(0, '/www/adcitra/panel/plugin/msonedrive')
        try:
...
class ftp:
    ...
    def __init__(self):
        if not '/www/adcitra/panel/plugin/ftp' in sys.path:
...
class jdcloud:
    ...
    def __init__(self):
        if not '/www/adcitra/panel/plugin/jdcloud' in sys.path:
            sys.path.insert(0, '/www/adcitra/panel/plugin/jdcloud')
        try:
...
class minio:
    ...
    def __init__(self):
        if not '/www/adcitra/panel/plugin/minio' in sys.path:
            sys.path.insert(0, '/www/adcitra/panel/plugin/minio')
        try:
...
class dogecloud:
    ...
    def __init__(self):
        if not '/www/adcitra/panel/plugin/dogecloud' in sys.path:
            sys.path.insert(0, '/www/adcitra/panel/plugin/dogecloud')
        try:
...
class alipan_manage:
    ...
    def __init__(self):
        if not '/www/adcitra/panel/plugin/alipan_manage' in sys.path:
            sys.path.insert(0, '/www/adcitra/panel/plugin/alipan_manage')
        try:
...
class CloudStoraUpload:
    ...
    def __init__(self):
        ...
        # 获取当前云存储的安装列表
        import json
        tmp = public.readFile('/www/adcitra/panel/data/libList.conf')
        if tmp:
            libs = json.loads(tmp)
            for lib in libs:
                if not 'opt' in lib: continue
                filename = '/www/adcitra/panel/plugin/{}'.format(lib['opt'])
