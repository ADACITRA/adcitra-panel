...
_tips = [
    "建议安装WAF防火墙，如：AdCtira灯塔Nginx防火墙、AdCtira灯塔Apache防火墙、Nginx免费防火墙、云锁、安全狗、悬镜等",
...
def check_run():
    ...
    waf_list = [
        '/www/adcitra/panel/plugin/adcitrawaf/info.json',
        '/www/adcitra/panel/plugin/adcitrawaf_httpd/info.json',
        '/www/adcitra/panel/plugin/free_waf/info.json',
