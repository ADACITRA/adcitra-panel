...
DEFAULT_HEADERS = {"Content-type":"application/x-www-form-urlencoded","User-Agent":"AdCtira-Panel"}
...
def get_stype(s_type):
    if not s_type:
        s_type_file = '/www/adcitra/panel/data/http_type.pl'
...
def post(url,data = {},timeout = (15,120),headers = {},verify = False,s_type = None):
    '''
        ...
        @param [headers] dict 请求头 默认{"Content-type":"application/x-www-form-urlencoded","User-Agent":"AdCtira-Panel"}
