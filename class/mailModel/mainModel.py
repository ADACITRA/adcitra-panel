...
class SendMail:
    ...
    发件类
    '''
    __setupPath = '/www/adcitra/panel/plugin/mail_sys'
    ...
    def _get_pubilc_ip(self):
        ...
        try:
            ...
            filename = '/www/adcitra/panel/data/iplist.txt'
    ...
    def _get_all_ip(self):
        ...
        locataddr = public.readFile('/www/adcitra/panel/data/iplist.txt')
        if not locataddr:
            locataddr = ""
...
class main(Base):
    ...
    def __init__(self):
        ...
        self.blacklist_tips = '/www/adcitra/panel/plugin/mail_sys/data/blacklist_tips'
        self.blacklist_alarm_switch = '/www/adcitra/panel/plugin/mail_sys/data/blacklist_alarm_switch'
        ...
        # self.back_log_path = '/www/adcitra/panel/data/mail/back_log'
    ...
    def update_task_count_table(self):
        path = '/www/adcitra/panel/data/update_mail_task_count_table.pl'
    ...
    def login_roundcube(self, args):
        ...
        # 读取文件 并替换指定字符
        tmp_file = "/www/adcitra/panel/class/mailModel/roundcube_autologin.php"
        ...
        # from AdCtiraPanel import redirect
        # return redirect(url)
    ...
    def get_domains(self, args):
        ...
        domain_ip = None
        path = '/www/adcitra/panel/plugin/mail_sys/domain_ip.json'
        if os.path.exists(path):
        ...
        for item in data_list:
            ...
            # 新增域名黑名单检查
            item['domain_check_log'] = f"/www/adcitra/panel/plugin/mail_sys/data/{item['a_record']}_blcheck.txt"
            ...
            if dns_data:
                ...
                if dns_dic:
                    ...
                    item['dns_id'] = "AdCtira灯塔DNS"
                    item['dns_name'] = "AdCtira灯塔DNS"
            bind = "@" + item['domain']
...
systemctl restart  opendkim'''.format(domain=domain)
    ...
    def add_domain(self, args):
        ...
        if 'ips' in args:
            ...
            # 记录域名的ip address    /www/adcitra/panel/plugin/mail_sys/domain_ip.json
            path = '/www/adcitra/panel/plugin/mail_sys/domain_ip.json'
    ...
    def delete_domain(self, args):
        ...
        # 删除域名黑名单检测日志
        domain_check_log = f'/www/adcitra/panel/plugin/mail_sys/data/{domain_info["a_record"]}_blcheck.txt'
    ...
    def send_mail(self, args):
        ...
        # ssl_staus = public.readFile('/www/adcitra/panel/data/ssl.pl')
        # if ssl_staus:
        #     ssl = 'https'
        # else:
        #     ssl = 'http'
...
if header :contains "X-Spam-Flag" "YES" {
    ...
    def turn_on_anti_spam(self, args):
        ...
        if args.spam_server_ip == 'localhost' and not os.path.exists(
                '/www/adcitra/panel/plugin/anti_spam'):
...
#DOMAIN_SSL_END_%s""" % (a_record, a_record, cert_file, cert_key, a_record)
    ...
    def set_mail_certificate_multiple(self, args):
        ...
        conf = public.readFile(self.postfix_main_cf)
        domain = args.domain
        cert_path = '/www/adcitra/panel/plugin/mail_sys/cert/{}'.format(domain)
    ...
    #     if not os.path.exists('/etc/redhat-release') and 'debian gnu/linux 10' not in self._get_ubuntu_version():
    #         if 'ubuntu 2' not in self._get_ubuntu_version():
    #             path = '/www/adcitra/panel/plugin/mail_sys/cert/'
    #     csrpath = path + "fullchain.pem"
    #     keypath = path + "privkey.pem"
    ...
    def _get_multiple_certificate_domain_status(self, domain):
        path = '/www/adcitra/panel/plugin/mail_sys/cert/{}/fullchain.pem'.format(domain)
        ssl_conf = public.readFile('/etc/postfix/vmail_ssl.map')
        # if not os.path.exists('/etc/redhat-release') and 'debian gnu/linux 10' not in self._get_ubuntu_version():
        #     if 'ubuntu 2' not in self._get_ubuntu_version():
        #         path = '/www/adcitra/panel/plugin/mail_sys/cert/fullchain.pem'
        if not os.path.exists(path):
            return False
    ...
    def get_ssl_info(self, domain):
        ...
        try:
            import data
            fullchain_file = '/www/adcitra/panel/plugin/mail_sys/cert/{}/fullchain.pem'.format(domain)
            privkey_file = '/www/adcitra/panel/plugin/mail_sys/cert/{}/privkey.pem'.format(domain)
    ...
    def check_rspamd_route(self, args):
        panel_init = public.readFile("/www/adcitra/panel/AdCtiraPanel/__init__.py")
    ...
    def create_service_monitor_task(self, get):
        ...
        try:
            ...
            if c_id:
                ...
                data['type'] = 'minute-n'
                data['where1'] = '1'
                data['sBody'] = 'btpython /www/adcitra/panel/class/mailModel/script/monitor_script.py'
                data['backupTo'] = ''
                data['sType'] = 'toShell'
                # data['hour'] = get.hour if 'hour' in get else ''
                # data['minute'] = get.minute if 'minute' in get else ''
    ...
    def export_users(self, get):
        ...
        rule_path = '/www/adcitra/panel/data/mail/'
    ...
    def _mail_logs_task(self, args):
        ...
        try:
            ...
            if not c_id:
                ...
                data['type'] = 'minute-n'
                data['where1'] = '10'
                data['sBody'] = 'btpython /www/adcitra/panel/class/mailModel/script/mail_logs.py'
                data['backupTo'] = ''
                data['sType'] = 'toShell'
                data['hour'] = ''
                data['minute'] = ''
    ...
    def add_roundcube(self, args):
        ...
        path = "/www/adcitra/panel/plugin/mail_sys/roundcube.json"
    ...
    def get_roundcube_status(self, args):
        ...
        # if versions < "6.0":
        #     return self.return_msg(public.returnMsg(False, '请在应用商定将AdCtira灯塔邮局升级到6.0或更高版本'))
    ...
    def _sync_blacklist_to_unsubscribe_db(self):
        ...
        if not os.path.exists('/www/vmail'):
            return
        # 判断同步标记
        path = '/www/adcitra/panel/data/mail_sync_black_to_unsubscribe_db.pl'
        if os.path.exists(path):
            return
    ...
    def task_cut_maillog(self):
        ...
        then
            ...
            btpython /www/adcitra/panel/class/mailModel/script/cut_maillog.py
        fi
        '''
        ...
        try:
            ...
            if not c_id:
                ...
                data['type'] = 'hour-n'
                data['where1'] = '1'
                data['sBody'] = 'btpython /www/adcitra/panel/class/mailModel/script/cut_maillog.py'
                data['backupTo'] = ''
                data['sType'] = 'toShell'
                data['hour'] = ''
                data['minute'] = '0'
    ...
    def remove_old_cron(self):
        ...
        if not os.path.exists('/www/vmail'):
            return
        # 判断删掉标记 如果不存在 就删掉就任务
        path = '/www/adcitra/panel/data/remove_old_mail_cron.pl'
        if os.path.exists(path):
            return
        # 判断已经存在任务
        c_id = public.M('crontab').where('name=?', u'[勿删] 切割邮件日志').getField('id')
    ...
    def open_auto_ssl_task(self, get):
        ...
        try:
            ...
            if c_id:
                ...
                data['type'] = 'day'
                data['where1'] = '1'
                data['sBody'] = '/www/adcitra/panel/pyenv/bin/python3 -u /www/adcitra/panel/class/mailModel/script/auto_renew_letssl.py'
                data['backupTo'] = ''
                data['sType'] = 'toShell'
