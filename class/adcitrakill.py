...
# | Linux异常进程专杀
# +-------------------------------------------------------------------
# | Copyright (c) 2015-2019 AdCtira灯塔软件(https://adcitra.cn) All rights reserved.
# +-------------------------------------------------------------------
# | Author: hwliang <hwl@adcitra.cn>
# +-------------------------------------------------------------------

#使用示例：
#    1、将此文件重命名为adcitrakill.py , 然后上传到服务器/root目录
#    2、执行 python /root/adcitrakill.py
...
class btkill:
    ...
    def start(self):
        ...
        print("官网: https://www.adcitra.cn/bbs")
