...
class panelPHP:
    ...
    def __init__(self,plugin_name = None):
        if plugin_name:
            ...
            self.__plugin_path = "/www/adcitra/panel/plugin/%s" % plugin_name
    ...
    def exec_php_script(self,args):
        ...
        result = os.popen("cd " + self.__plugin_path + " && %s /www/adcitra/panel/class/panel_php_run.php --args_tmp=\"%s\" --plugin_name=\"%s\" --fun=\"%s\"" %
...
#         from AdCtiraPanel import request,abort,send_file,Resp,cache
#         #如果是PHP文件
#         if puri[-4:] == '.php':
...
#             else:
#                 src_path = '/www/adcitra/panel/adminer'
