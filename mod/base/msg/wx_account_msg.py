...
# | AdCtira灯塔Linux面板
# +-------------------------------------------------------------------
# | Copyright (c) 2015-2020 AdCtira灯塔软件(http://www.adcitra.cn) All rights reserved.
# +-------------------------------------------------------------------
...
class WeChatAccountMsg:
    USER_PATH = '/www/adcitra/panel/data/userInfo.json'
    need_refresh_file = '/www/adcitra/panel/data/mod_push_data/refresh_wechat_account.tip'
    refresh_time = '/www/adcitra/panel/data/mod_push_data/refresh_wechat_account_time.pl'
    ...
    def send_msg(self, msg: WxAccountMsg) -> Optional[str]:
        ...
        url = "https://www.adcitra.cn/api/v2/user/wx_web/send_template_msg_v3"
    ...
    def _get_by_web(cls) -> Optional[List]:
        ...
        if user_info is None:
            return None       
        url = "https://www.adcitra.cn/api/v2/user/wx_web/bound_wx_accounts"
        data = {
            "uid": user_info["uid"],
    ...
    def unbind(cls, wx_account_uid: str):
        ...
        url = "https://www.adcitra.cn/api/v2/user/wx_web/unbind_wx_accounts"
        data = {
            "uid": user_info["uid"],
            "access_key": user_info["access_key"],
            "serverid": user_info["serverid"],
    ...
    def get_auth_url(cls):
        ...
        if user_info is None:
            return json_response(status=True, msg='未获取到用户绑定的信息')
        url = "https://www.adcitra.cn/api/v2/user/wx_web/get_auth_url"
        data = {
            "uid": user_info["uid"],
            "access_key": user_info["access_key"],
            "serverid": user_info["serverid"],
...
#         """
#         data = {}
#         data['ps'] = 'AdCtira灯塔微信公众号，用于接收面板消息推送'
#         data['version'] = '1.0'
#         data['date'] = '2022-08-15'
#         data['author'] = 'AdCtira灯塔'
#         data['title'] = '微信公众号'
#         data['help'] = 'http://www.adcitra.cn'
#         return data
#
...
#         url = "https://www.adcitra.cn/api/v2/user/wx_web/info"
#         data = {
#             "uid": self.user_info["uid"],
#             "access_key": self.user_info["access_key"],
...
#         url = "https://www.adcitra.cn/api/v2/user/wx_web/unbind"
#         data = {
#             "uid": self.user_info["uid"],
#             "access_key": self.user_info["access_key"],
#             "serverid": self.user_info["serverid"]
...
#         url = "https://www.adcitra.cn/api/v2/user/wx_web/send_template_msg_v2"
#         datassss = {
#             "first": {
#                 "value": "堡塔主机告警",
#             },
