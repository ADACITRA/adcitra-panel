...
""".format(self.user_config.get('name', "--"), self.user_config.get('password', "--"))
    ...
    def _create_ssh_key() -> str:
        ...
        key_type_file = '/www/adcitra/panel/data/ssh_key_type.pl'
...
class RealGitMager:
    _git_config_file = "/www/adcitra/panel/data/site_git_config.json"
    ...
    def __init__(self):
        ...
        #         "id": "",
        #         "site_name": "aaaa",
        #         "url": "http://git.adcitra.cn/cjxin/panel-plugin.git",  # ssh://git@git.adcitra.cn/cjxin/panel-plugin.git
        #         "path_ino": 4564524,
