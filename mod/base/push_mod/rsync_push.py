...
def rsync_ver_is_38() -> Optional[bool]:
    ...
    """
    push_file = "/www/adcitra/panel/plugin/rsync/rsync_push.py"
    if not os.path.exists(push_file):
        return None
    ver_info_file = "/www/adcitra/panel/plugin/rsync/info.json"
...
class Rsync38Task(BaseTask):
    ...
    def _check(interval: int) -> bool:
        ...
        log_file = "{}/plugin/rsync/lsyncd.log".format("/www/adcitra/panel")
    ...
    def task_config_update_hook(self, task: dict) -> Optional[str]:
        old_file = "/www/adcitra/panel/class/push/push.json"
        try:
