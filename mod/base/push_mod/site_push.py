...
class PanelLoginTask(BaseTask):
    push_tip_file = "/www/adcitra/panel/data/panel_login_send.pl"
...
class SSHLoginTask(BaseTask):
    push_tip_file = "/www/adcitra/panel/data/ssh_send_type.pl"
...
class PanelUpdateTask(BaseTask):
    ...
    def _get_no_user_tip(self) -> str:
        ...
        tip_file = "/www/adcitra/panel/data/no_user_tip.pl"
    ...
    def get_push_data(self, task_id: str, task_data: dict) -> Optional[dict]:
        ...
        try:
            res = json.loads(read_file('/www/adcitra/panel/data/node_url.pl'))
            www_url = res['www-node']['url']
            s_url = 'https://{}{}'.format(www_url, sub_path)
        except:
            s_url = 'https://www.adcitra.cn{}'.format(sub_path)
        try:
