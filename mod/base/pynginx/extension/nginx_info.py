...
class NgInfo:
    ...
    def listen_ipv6(self) -> bool:
        ...
        if "--with-ipv6" not in self._v_out:
            return False
        self._listen_ipv6 = os.path.exists('/www/adcitra/panel/data/ipv6.pl')
        return self._listen_ipv6
    ...
    def tls_versions(self) -> List[str]:
        ...
        try:
            file_path = "/www/adcitra/panel/data/ssl_protocol.json"
    ...
    def default_http2https():
        http2https_pl = "/www/adcitra/panel/data/http2https.pl"
