...
│   └── utils.py         # 工具函数
└── adcitra_nginx/             # 第三方Nginx接入实现
    ├── nginx_detector.py # Nginx实例探测器
    ├── site_detector.py  # 站点配置分离与分类
    ├── adcitra_formater.py    # 面板兼容配置格式化
...
### 使用示例
```python
from mod.base.pynginx.adcitra_nginx.nginx_detector import ng_detect, ng_detect_by_bin
...
from mod.base.pynginx.adcitra_nginx.site_detector import site_detector, SiteInfo
...
### 使用示例
```python
from mod.base.pynginx.adcitra_nginx.bt_formater import bt_nginx_format
from mod.base.pynginx.adcitra_nginx.nginx_detector import ng_detect
...
# 5. 在面板中创建站点
from mod.base.pynginx.adcitra_nginx.create_site import CreateSiteUtil
