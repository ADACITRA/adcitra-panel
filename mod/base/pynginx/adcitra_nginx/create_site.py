...
_VHOST_PATH = "/www/adcitra/panel/vhost"
...
class CreateSiteUtil:
    ...
    def create_proxy_site(self, proxy_site: dict):
        site_id = 0
        site_nginx_config_file = "/www/adcitra/panel/vhost/nginx/{}.conf".format(proxy_site["name"])
    ...
    def create_html_site(self, html_site: dict):
        site_id = 0
        site_nginx_config_file = "/www/adcitra/panel/vhost/nginx/html_{}.conf".format(html_site["name"])
    ...
    def create_php_site(self, php_site: dict):
        site_id = 0
        site_nginx_config_file = "/www/adcitra/panel/vhost/nginx/{}.conf".format(php_site["name"])
        ngx_open_basedir_path = _VHOST_PATH + '/open_basedir/nginx'
        if not os.path.exists(ngx_open_basedir_path):
