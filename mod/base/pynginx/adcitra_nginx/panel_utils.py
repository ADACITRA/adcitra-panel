...
def panel_configs() -> List[str]:
    vhost_dir = "/www/adcitra/panel/vhost/nginx"
    ...
    try:
        db_file = "/www/adcitra/panel/data/db/site.db"
    ...
    try:
        db_file = "/www/adcitra/panel/data/db/docker.db"
        with sqlite3.connect(db_file) as conn:
            cursor = conn.cursor()
