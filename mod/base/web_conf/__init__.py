...
def remove_sites_service_config(site_name: str, config_prefix: str = ""):
    ...
    """
    # 配置文件
    ng_file = "/www/adcitra/panel/vhost/nginx/{}{}.conf".format(config_prefix, site_name)
    if os.path.exists(ng_file):
        os.remove(ng_file)
    ap_file = "/www/adcitra/panel/vhost/apache/{}{}.conf".format(config_prefix, site_name)
    ...
    # 证书目录
    cert_path = "/www/adcitra/panel/vhost/cert/" + site_name
    ...
    if d_site_name == site_name and d_prefix == config_prefix:
        d_file = "/www/adcitra/panel/data/mod_default_site.pl"
    ...
    # 伪静态
    rewrite_path = "/www/adcitra/panel/vhost/rewrite/{}{}.conf".format(config_prefix, site_name)
