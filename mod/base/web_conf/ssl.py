...
class RealSSLManger:
    ...
    def __init__(self, conf_prefix=""):
        ...
        self._vhost_path = "/www/adcitra/panel/vhost"
    ...
    def _get_ssl_by_local_data(self):  # 从本地获取可用证书
        local_paths = ['/www/adcitra/panel/vhost/cert', '/www/adcitra/panel/vhost/ssl']
        ...
        panel_pem_file = "/www/adcitra/panel/ssl/fullchain.pem"
        panel_key_file = "/www/adcitra/panel/ssl/privkey.pem"
    ...
    def _get_site_ssl_info(site_name, prefix='') -> Optional[Tuple[str, str]]:
        path = os.path.join('/www/adcitra/panel/vhost/cert/', site_name)
    ...
    def set_site_ssl_conf(self, site_name: str, ssl_data: dict, mutil=False) -> Optional[str]:
        ...
        path = '/www/adcitra/panel/vhost/cert/' + site_name
        if not os.path.exists(path):
            os.makedirs(path)
