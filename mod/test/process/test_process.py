...
class TestRealProcess(unittest.TestCase):
    ...
    #     try:
    #         pid = real_process.get_process_info_by_exec('/www/adcitra/panel/mod/test/process/test.py')['data'][0]['pid']
    ...
    #     try:
    #         name = real_process.get_process_info_by_exec('/www/adcitra/panel/mod/test/process/test.py')['data'][0]['name']
