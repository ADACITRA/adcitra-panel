...
if not panelPath: panelPath = '/www/adcitra/panel'
...
class RAGService:
    def __init__(
        ...
        self.embedding_base_url = public.get_home_node(embedding_url) if embedding_url and 'adcitra.cn' in embedding_url else embedding_url
        ...
        self.emb_base_url = public.get_home_node(embedding_base_url) if embedding_base_url and 'adcitra.cn' in embedding_base_url else embedding_base_url
...
class ExternalRAGService:
    API_URL = "https://www.adcitra.cn/plugin_api/chat/api/knowledge-base/retrieve"
    ...
    def __init__(
        ...
        api_key: str = "--",
        base_url: str = "https://www.adcitra.cn/plugin_api/chat/openai/v3",
        model_name: str = "fast",
        ...
        self.judgment_base_url = public.get_home_node(base_url) if base_url and 'adcitra.cn' in base_url else base_url
...
请以 JSON 格式返回：
{
    ...
    def search(self, query: str, score: float = 0.2, scope: str = "session", full_text: bool = True, enable_rag_judgment: bool = None, session_history: List[Dict[str, Any]] = None) -> List[str]:
        ...
        try:
            ...
            api_url = public.get_home_node(self.API_URL) if 'adcitra.cn' in self.API_URL else self.API_URL
