...
class ProjectUpdate:
    ...
    def set_nginx_upstream(self) -> Optional[str]:
        self.keep_status[1]["status"] = -1
        ng_file = "/www/adcitra/panel/vhost/nginx/java_{}.conf".format(self.project_name)
        ...
        upstream_file = "/www/adcitra/panel/vhost/nginx/java_{}_upstream.conf".format(self.project_name)
