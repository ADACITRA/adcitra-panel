...
def set_java_service_link():
    ...
    java_service_src = '/www/adcitra/panel/script/java-service.py'
...
class main(JavaWebConfig, Proxy, Redirect, GitMager):
    ...
    def update_project_by_keep(self, get):
        ...
        ng_file = "/www/adcitra/panel/vhost/nginx/java_{}.conf".format(project_name)
    ...
    def force_stop(self, get):
        ...
        upstream_file = "/www/adcitra/panel/vhost/nginx/java_{}_upstream.conf".format(project_name)
