...
class JDKManager:
    ...
    def __init__(self):
        ...
        self._custom_file = "/www/adcitra/panel/data/get_local_jdk.json"
    ...
    def versions_list(self) -> List[str]:
        ...
        jdk_json_file = '/www/adcitra/panel/data/jdk.json'
        tip_file = '/www/adcitra/panel/data/jdk.json.pl'
        try:
    ...
    def async_install_jdk(self, version: str) -> None:
        sh_str = "cd /www/adcitra/panel/install && /bin/bash install_soft.sh {} install {} {}".format(0, 'jdk', version)
    ...
    def _install_jdk(self, version: str) -> None:
        try:
            ...
            public.ExecShell('bash /www/adcitra/panel/install/jdk.sh install {} 2>&1 > {}'.format(version, log_file))
        except:
            pass
