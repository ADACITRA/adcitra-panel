...
class DatabaseModule(DataManager,BaseUtil,ConfigManager):
    ...
    def backup_sqlite_data(self,timestamp):
        db_model_path="/www/adcitra/panel/data/db_model.json"
    ...
    #     try:
    #         if not os.path.exists("/www/adcitra/panel/data/remysql_root.pl"):
    ...
    #             public.ExecShell("echo 'True' > /www/adcitra/panel/data/remysql_root.pl")
    #     except:
    #         pass
    ...
    def init_mysql_root(self,get=None):
        try:
            if not os.path.exists("/www/adcitra/panel/data/remysql_root.pl"):
                ...
                init_root_cmd="btpython /www/adcitra/panel/tools.py root {}".format(root_pwd)
    ...
    def restore_pgsql_data(self,db_data):
        ...
        try:
            ...
            # 获取本地PostgreSQL的配置信息
            t_path = os.path.join('/www/adcitra/panel/data/postgresAS.json')
            if not os.path.isfile(t_path):
