...
class main:
    ...
    def request(self, params=None):
        if params is None:
            params = {}
        request_url = "https://api.adcitra.cn/v2/domain/proxy"
    ...
    def get_analysis_ip(self, get=None):
        path = "/www/adcitra/panel/data/domain_ip.pl"
    ...
    def poxy_whois_query(self, get):
        ...
        rep = requests.get(public.get_home_node("https://www.adcitra.cn/api/whois/query"), vars(get))
        try:
            data = rep.json()
        except Exception as e:
