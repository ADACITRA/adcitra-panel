...
class PythonEnvironment:
    """Python环境元数据载体类"""
    _BT_PROJECT_ENV_SHELL = "/www/server/python_project/adcitra_pyprojectenv.sh"
    _bt_etc_pyenv = "/www/adcitra/panel/data/bt_etc_pyenv.sh"
    project_to_pyenv_map_file = "/www/adcitra/panel/data/python_project_name2env.txt"
...
if [ -f '/www/adcitra/panel/data/bt_etc_pyenv.sh' ]; then source /www/adcitra/panel/data/bt_etc_pyenv.sh; fi
# End-Python-Env
"""
...
""" + res_sh
    ...
    def profile_env_bin(cls) -> Optional[str]:
        ...
        for line in data.split("\n"):
            if line.find("source /www/adcitra/panel/data/bt_etc_pyenv.sh"):
                break
        else:
            return None
...
class EnvironmentReporter:
    """环境报告生成器"""
    REPORT_FILE = "/www/adcitra/panel/data/python_project_env.json"
...
class EnvironmentManager:
    _REPORT_FILE = "/www/adcitra/panel/data/python_project_env.json"
