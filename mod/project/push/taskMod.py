...
def update_mod():
    ...
    if pl:
        load_task_template_by_file("/www/adcitra/panel/mod/base/push_mod/site_push_template.json")
        load_task_template_by_file("/www/adcitra/panel/mod/base/push_mod/system_push_template.json")
        load_task_template_by_file("/www/adcitra/panel/mod/base/push_mod/database_push_template.json")
        load_task_template_by_file("/www/adcitra/panel/mod/base/push_mod/ssl_push_template.json")
        load_task_template_by_file("/www/adcitra/panel/mod/base/push_mod/ftp_push_template.json")
        load_task_template_by_file("/www/adcitra/panel/mod/base/push_mod/safe_mod_push_template.json")
        load_task_template_by_file("/www/adcitra/panel/mod/base/push_mod/monitor_push_template.json")
        load_task_template_by_file("/www/adcitra/panel/mod/base/push_mod/mod_node_push_template.json")
        load_rsync_template()
    ...
    check_mod_push_file = "/www/adcitra/panel/data/mod_push_data/check_mod_push_file.pl"
    if not os.path.exists(check_mod_push_file):
        ExecShell('nohup btpython /www/adcitra/panel/script/migrate_push_tasks.py > /dev/null 2>&1 &')
