...
class App(composeMod):
    ...
    def __init__(self):
        ...
        # self.apps_json_file = os.path.join("/www/adcitra/panel/mod/project/docker/app", "apps.json")
        self.app_json = None
        self.apps_json = None
        self.apps_list = None
        self.app_tags_file = os.path.join(self.project_path, "apptags.json")
        # self.app_tags_file = os.path.join("/www/adcitra/panel/mod/project/docker/app", "apptags.json")
    ...
    def update_ico(self):
        '''
            @name 更新图标
        '''
        zip_ico_path = "{}/AdCtiraPanel/static/img/soft_ico/".format(public.get_panel_path())
        ico_path = os.path.join(public.get_panel_path(), "AdCtiraPanel/static/img/soft_ico/dkapp")
