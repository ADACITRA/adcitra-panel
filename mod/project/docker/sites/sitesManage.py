...
location ~ [^/]\.php(/|$) {{
    ...
    def run_php(self, get):
        ...
        from adcitraDockerModel.dockerSock import image
    ...
    def delete_site(self, get):
        ...
        nginx_conf = os.path.join("/www/adcitra/panel/vhost/nginx", "{}.conf".format(find_result["name"]))
    ...
    def GetSecurity(self, get):
        ...
        if conf.find('SECURITY-START') != -1:
            ...
            conf_file = '/www/adcitra/panel/vhost/config/{}_door_chain.json'.format(get.name)
            try:
    ...
    def get_default_site(self, get):
        ...
        default_site = public.readFile('/www/adcitra/panel/data/defaultSite.pl')
    ...
    def set_default_site(self, get):
        ...
        old_default_site = public.readFile('/www/adcitra/panel/data/defaultSite.pl')
        if not old_default_site:
            if get.site_name == "0":
                public.ExecShell("rm -f /www/adcitra/panel/data/defaultSite.pl")
                return public.returnResult(msg="设置成功！")
        ...
        public.writeFile('/www/adcitra/panel/data/defaultSite.pl', get.site_name)
